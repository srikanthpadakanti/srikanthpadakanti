...
Software engineer focused on distributed systems, data pipelines, and observability. Contributor to the OpenSearch project with work across Data Prepper, the SQL plugin, and OpenSearch core.

- 🔭 Currently working on metrics ingestion pipelines and OpenSearch TSDB integration
- 🌱 Exploring time series storage engines and query optimization
- 💬 Ask me about Data Prepper, OpenSearch, Prometheus, or distributed systems
